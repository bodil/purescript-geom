...
data Transform = Transform Number Number Number Number Number Number Number Number Number Number
...
instance eqTransform :: Eq Transform where
  (==) (Transform a1 b1 c1 d1 e1 f1 g1 h1 i1 o1)
    (Transform a2 b2 c2 d2 e2 f2 g2 h2 i2 o2) =
...
rotateAround x y angle =
  let r00 = cos angle
      r10 = sin angle
      r01 = (0 - r10)
  in Transform r00 r01 (x - (r00*x) - (r01*y)) r10 r00 (y - (r10*x) - (r00*y)) 0 0 1 1

-- |Create a transform that scales by a given factor.
scale :: Number -> Transform
scale s = Transform s 0 0 0 s 0 0 0 1 1

-- |Create a transform that scales only the X axis by a given factor.
scaleX :: Number -> Transform
scaleX s = Transform s 0 0 0 1 0 0 0 1 1

-- |Create a transform that scales only the Y axis by a given factor.
scaleY :: Number -> Transform
scaleY s = Transform 1 0 0 0 s 0 0 0 1 1

-- |Craete a transform that adjusts opacity.
opacity :: Number -> Transform
opacity o = Transform 1 0 0 0 1 0 0 0 1 o

-- |Add two matrices together.
compose :: Transform -> Transform -> Transform
compose (Transform a1 b1 c1 p1 q1 r1 u1 v1 w1 o1)
        (Transform a2 b2 c2 p2 q2 r2 u2 v2 w2 o2) =
...
instance showTransform :: Show Transform where
  show (Transform a b c d e f g h i o) =
